...
var tests = [
    ...
    [
        ...
        { .map{.normalize.collapse.trim.title.naturally}«cmp» }
    ],
    [
        ...
        { .map{.latin1_decompose.naturally}«cmp» }
    ]
];
 
tests.each { |case|
